...
public static class Day1_2023
{
    public static void Run(string testInputPath, string challengeInputPath)
    {
        ...
        // part 2
        var testpath2 = Path.Combine(Path.GetDirectoryName(testInputPath)!,
    ...
    private static Dictionary<int, int> GetTokens(string line)
    {
    ...
    private static int ParseMatch(string m)
    {
        return m switch
        {
            "one" => 1,
